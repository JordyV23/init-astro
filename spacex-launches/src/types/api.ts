// To parse this data:
//
//   import { Convert, APIResponseSpaceX } from "./file";
//
//   const aPIResponseSpaceX = Convert.toAPIResponseSpaceX(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface APIResponseSpaceX {
  docs: Doc[];
  totalDocs: number;
  offset: number;
  limit: number;
...
export class Convert {
  public static toAPIResponseSpaceX(json: string): APIResponseSpaceX {
    return cast(JSON.parse(json), r("APIResponseSpaceX"));
  }

  public static aPIResponseSpaceXToJson(value: APIResponseSpaceX): string {
    return JSON.stringify(uncast(value, r("APIResponseSpaceX")), null, 2);
  }
}
